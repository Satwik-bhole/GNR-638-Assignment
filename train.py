...
def main(test_path, load_path):
    # Requirement: Report dataset loading time during evaluation [cite: 39, 40, 102]
    ...
    # Reconstruct MATCHING architecture
    ...
    # Requirement: Report parameters and MACs [cite: 48, 101]
    ...
    for i in range(0, total, BATCH_SIZE):
        ...
        if not metrics_printed:
            ...
            print(f"MACs per forward pass: {macs_val}")
        ...
        if (i // BATCH_SIZE) % 5 == 0:
            print(f"Evaluated {batch_end}/{total} images...", end='\r')
